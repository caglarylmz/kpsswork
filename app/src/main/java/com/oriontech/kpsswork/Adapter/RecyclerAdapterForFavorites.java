...
public class RecyclerAdapterForFavorites extends RecyclerView.Adapter<RecyclerAdapterForFavorites.KonularViewHolder> {
    private Context context;
    private List<Konular> konularList;
    private MyClickListener listener;
    private DBHelper db;

    public RecyclerAdapterForFavorites(Context context, List<Konular> konularList) {
    ...
    public KonularViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.item_list_favorites,null);
    ...
    class KonularViewHolder extends RecyclerView.ViewHolder{
        ...
        public KonularViewHolder(View itemView, final MyClickListener listener) {
            ...
            tvKonuId=itemView.findViewById(R.id.konuID_itemFavorites);
            tvKonuAdi=itemView.findViewById(R.id.konuAdi_itemFavorites);
            tvSoruSayisi=itemView.findViewById(R.id.SoruSayisi_itemFavorites);
            tvDogruSayisi=itemView.findViewById(R.id.DogruSayisi_itemFavorites);
            tvYanlisSayisi=itemView.findViewById(R.id.YanlisSayisi_itemFavorites);
            ivFavori=itemView.findViewById(R.id.ivListitem_Favorites__itemFavorites);
